...
class ViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate {
    ...
    lazy var vc1: Repertoire = {
        
        
        let setListsStoryboard = UIStoryboard(name: "Repertoire", bundle: nil)
        
        var viewController = setListsStoryboard.instantiateViewController(withIdentifier: "Repertoire") as! Repertoire
    ...
    lazy var vc2: Setlists = {
        
        let repertoireStoryboard = UIStoryboard(name: "Setlists", bundle: nil)

        var viewController = repertoireStoryboard.instantiateViewController(withIdentifier: "Setlists") as! Setlists
        //self.addViewControllerAsChildViewController(childViewController: viewController)
